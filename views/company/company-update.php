            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Atualizar Nível</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    <h3 class="box-title">
                                        <p style="font-size: 15px">Nível de Acesso:&nbsp;&nbsp;<b><?= $levels[0]['level'] ?></b>
                                    </h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <form id="level-create" class="form-control-static" action="/levels/update/<?= $levels[0]['idlevel'] ?>" method="POST">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="level" class="form-control" placeholder="Nível de Acesso" autofocus="true" onclick="this.select()" value="<?= $levels[0]['level'] ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-8">
                                                ...
                                                <div class="nav-tabs-custom tab-success">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane active" id="pap">
                                                                    ...
                                                                    <a href="#">
                                                                        <label>
                                                                            ...
                                                                            if(array_key_exists($i, $levels)) {
                                                                                if($levels[$i]['idmodule'] === $item['idmodule']) {
                                                                                   echo "checked";
                                                                                   $increment = true;
                                                                                }
                                                                            }
                                                                            ...
                                                                            <ul class="treevew-menu">
                                                                                <li>
                                                                                    <label>
                                                                                        ...
                                                                                        <?php
                                                                                        if(array_key_exists($i, $levels)) {
                                                                                            if($levels[$i]['idmodule'] === $item['idmodule'] && $levels[$i]['desview'] === "1") {
                                                                                                echo "checked";
                                                                                            }
                                                                                        }
                                                                                        ?>>
                                                                                ...
                                                                                <li>
                                                                                    <label>
                                                                                        ...
                                                                                        <?php
                                                                                        if(array_key_exists($i, $levels)) {
                                                                                            if($levels[$i]['idmodule'] === $item['idmodule'] && $levels[$i]['desregister'] === "1") {
                                                                                               echo "checked";
                                                                                            }
                                                                                        }
                                                                                        ?>>
                                                                                ...
                                                                                <li>
                                                                                    <label>
                                                                                        ...
                                                                                        <?php
                                                                                        if(array_key_exists($i, $levels)) {
                                                                                            if($levels[$i]['idmodule'] === $item['idmodule'] && $levels[$i]['desedit'] === "1") {
                                                                                               echo "checked";
                                                                                            }
                                                                                        }
                                                                                        ?>>
                                                                                ...
                                                                                <li>
                                                                                    <label>
                                                                                        ...
                                                                                        <?php
                                                                                        if(array_key_exists($i, $levels)) {
                                                                                            if($levels[$i]['idmodule'] === $item['idmodule'] && $levels[$i]['desdelete'] === "1") {
                                                                                               echo "checked";
                                                                                            }
                                                                                        }
                                                                                        ?>>
                                                            ...
                                                            <?php if($increment){$i++; $increment = false;} ?>  
                                                            <?php endif; ?>
                                                            <?php endforeach; ?>
                                                            </ul>
                                                        </div>
                                                        ...
                                                        <div class="tab-pane" id="fin">
                                                            ...
                                                            <?php if ($item['project'] === "Financeiro"): ?>
                                                                <li class="treeview">
                                                                    <a href="#">
                                                                        <label>
                                                                            <input type="checkbox" name="idmodule[]" id="module<?= $item['idmodule'] ?>" value="<?= $item['idmodule'] ?>" class="square-green"
                                                                            <?php
                                                                            if(array_key_exists($i, $levels)) {
                                                                                if($levels[$i]['idmodule'] === $item['idmodule']) {
                                                                                   echo "checked";
